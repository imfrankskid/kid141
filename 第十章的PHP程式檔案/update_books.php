...
<center>
<br>
<form action="update_books_data.php" method="post" name = "form1">
<h3>請輸入書籍資料要做更新的條件</h3>
<table border=2>
<tr bgcolor="cc66ff">
...
<br>
<font size=4 color=green><b>以下是關聯表 Books 的內容(資料更新前)</b></font>
<br>
<table border=2>
<tr bgcolor="cc66ff">
<th><font color=white>編號<th><font color=white>書名<th><font color=white>作者
